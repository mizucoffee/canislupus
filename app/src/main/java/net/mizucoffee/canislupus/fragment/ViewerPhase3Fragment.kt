...
class ViewerPhase3Fragment(val data: String) : Fragment() {

    companion object {
        fun newInstance(data: String) = ViewerPhase3Fragment(data)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val p3 = Gson().fromJson<Phase1>(data, Phase1::class.java)
        player.text = "${p3.name}さん"
    }
}
